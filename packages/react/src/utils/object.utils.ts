 ...
 * @example <caption>Object path</caption>
 * type Example = BuildNested<['a', 'b', 'c'], number>; // { a: { b: { c: number } } }
 * @example <caption>Numeric segments become array indices</caption>
 * type Example = BuildNested<['users', '0', 'name'], string>; // { users: Array<{ name: string }> }
 */
 ...
 * @example <caption>Merging a nested value</caption>
 * type Example = SetNestedValue<{ x: string }, ['a', 'b'], number>; // { x: string; a: { b: number } }
 */
 ...
 * @example <caption>Dot-notation conversion</caption>
 * type Example = PathArrayToString<['a', 'b', 'c']>; // 'a.b.c'
 */
 ...
 * @example <caption>Removing a nested property</caption>
 * type Example = DeleteNestedValue<{ x: string; a: { b: { c: number } } }, ['a', 'b', 'c']>; // { x: string; a: { b: {} } }
 */
