...
**The reborn `awaitFreshRender` helper** (`apps/ui/app/lib/await-fresh-render.ts`):
...
| R26 | Add an `awaitFreshRender` test suite (`apps/ui/app/lib/await-fresh-render.test.ts`): settled-no-op, defensive `openFile` re-issue when intent mismatches context, no-preempt for in-flight render covering the request, RENDER_TIMEOUT, monotonic-safe out-of-order completion                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | P0       | M      | Lock the helper                              |
