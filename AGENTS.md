...
- Model benchmark suite at `apps/api/app/benchmarks/` — runner, geometry grader, HTML report generator for evaluating AI model performance on CAD tasks; outputs JSON + HTML reports with geometry validation results
