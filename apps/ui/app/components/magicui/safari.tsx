...
export function Safari({
  ...
  // Generate unique IDs for SVG elements to avoid conflicts when multiple Safari components are rendered
  const clipPathId = `safariClip-${id}`;

  return (
    <div
      className={`flex w-full flex-col overflow-hidden rounded-xl border border-[#E5E5E5] dark:border-[#404040] ${className ?? ''}`}
      style={style}
      {...props}
    >
      {/* Header/Toolbar */}
      <div className='relative shrink-0 bg-[#E5E5E5] dark:bg-[#404040]'>
        <svg
        ...
        >
          <defs>
            <clipPath id={clipPathId}>
              <rect width={headerWidth} height={headerHeight} fill='white' />
            </clipPath>
          </defs>
      ...
      {/* Content Area */}
      <div className='relative min-h-0 flex-1 bg-[#E5E5E5] dark:bg-[#404040]'>
        {hasVideo ? (
          <video autoPlay loop muted playsInline className='block w-full' src={videoSrc} preload='metadata' />
        ) : imageSrc ? (
