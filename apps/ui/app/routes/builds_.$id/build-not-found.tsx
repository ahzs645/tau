...
type BuildNotFoundProperties = {
  readonly className?: string;
};

export function BuildNotFound({ className }: BuildNotFoundProperties): React.JSX.Element {
  ...
  return (
    <div className={cn('absolute inset-0 z-20 mx-2', className)}>
      <FloatingPanel isOpen side="right" align="start" className="rounded-sm border">
        <FloatingPanelContent>
          <FloatingPanelContentHeader>
            <FloatingPanelContentTitle>Build Not Found</FloatingPanelContentTitle>
          </FloatingPanelContentHeader>
            ...
            <div className="w-full max-w-sm animate-in duration-300 fade-in">
              ...
              <div className="mb-6 rounded-lg border border-border/60 bg-card/80 p-4 text-center shadow-sm dark:border-border/40 dark:bg-card/50">
                <p className="text-muted-foreground">
                  The build you&apos;re looking for doesn&apos;t exist or may have been deleted.
                </p>
              </div>
