...
describe('sortCompilationEntries', () => {
  it('should place mainEntryFile first', () => {
    ...
    const sorted = sortCompilationEntries(entries, 'main.ts');
  ...
  it('should not mutate the original array', () => {
    ...
    sortCompilationEntries(entries, 'main.ts');
    expect(entries).toEqual(original);
  });

  it('should handle empty array', () => {
    const sorted = sortCompilationEntries([], 'main.ts');
