...
- [Using Middleware](../guides/using-middleware) — Add built-in middleware to your client
- [Create Custom Middleware](../guides/custom-middleware) — Implement middleware with `defineMiddleware`
- [API: Middleware](../api/middleware) — `defineMiddleware`, `KernelMiddleware`, and wrap hook types
