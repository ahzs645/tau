...
- [API: Transport](../api/transport) — `KernelTransport` and `createWorkerTransport`
- [Bundler Configuration](../guides/bundler-configuration) — Worker and bundler setup
- [Filesystem Setup](../guides/filesystem-setup) — Connecting a filesystem to the worker
