...
<auto-type-table path='./props/filesystem.ts' name='RuntimeFileSystemHandle' />
...
- [API: Types](./types) -- `RuntimeFileSystemBase`, `RuntimeFileSystem` (framework view), `RuntimeFileSystemHandle` (connect-time discriminant)
