...
| **`@kittycad/lib`** types + tsgo `exports`            | Add **`compilerOptions.paths`** for `"@kittycad/lib"` → `node_modules/@kittycad/lib/dist/types/src/index.d.ts` in **`packages/runtime/tsconfig.{lib,spec}.json`** and **`apps/ui/tsconfig.{app,spec}.json`**. |
